        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-gradient-to-b from-white via-sky-50 to-sky-100 border border-gray-200 rounded-2xl p-8 shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 backdrop-blur-sm fade-card delay-200">
            ...
            <p className="mt-3 text-gray-600 leading-relaxed">
              Maximize performance and stability Drivers Connect ensures your device always has the latest and most compatible drivers.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-b from-white via-sky-50 to-sky-100 border border-gray-200 rounded-2xl p-8 shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 backdrop-blur-sm fade-card delay-200">
            ...
            <p className="mt-3 text-gray-600 leading-relaxed">
              Drivers Connect enhances system speed and stability by cleaning clutter and optimizing performance.
            </p>
          </div>
