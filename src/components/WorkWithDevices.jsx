function WorkWithDevices() {
  ...
  <div className="container py-20 md:px-20">
    ...
    <p className="text-center text-gray-600 mt-4 max-w-2xl mx-auto">
      DriversConnect helps keep your PC up to date with smart driver updates, performance optimization, and reliable system maintenance for a smoother experience.
    </p>
