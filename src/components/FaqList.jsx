...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "By keeping your device drivers up to date, DriversConnect helps improve system stability and ensures your hardware runs as intended. It simplifies the process of managing driver updates safely.",
  },
  {
    question: "Is DriversConnect safe to use?",
    answer:
      "Yes. DriversConnect uses secure methods to check for updates and only installs trusted drivers that match your system specifications.",
  },
  {
    ...
    <section className="bg-[#04121d] py-10 w-full">
      <div className="container mx-auto flex flex-col items-center gap-10 px-4 md:px-20">
        <h2 className="text-2xl md:text-4xl font-extrabold text-center text-white leading-snug">
          Frequently Asked <span className="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600">Questions</span>
        </h2>
